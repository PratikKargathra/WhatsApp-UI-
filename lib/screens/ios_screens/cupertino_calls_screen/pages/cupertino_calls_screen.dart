...
class IOSCallPage extends StatefulWidget {
  const IOSCallPage({Key? key}) : super(key: key);

  @override
  State<IOSCallPage> createState() => _IOSCallPageState();
}

class _IOSCallPageState extends State<IOSCallPage> {
  @override
                      ...
                      Row(
                        children: [
                          ...
                          Icon(
                            ...
                            color: color.cupertinoMainColor,
                          )
                        ],
                      ),
                    ],
