                    ...
                    children: [
                      const CircleAvatar(
                        backgroundImage: NetworkImage(
                         'https://source.unsplash.com/1600x900/?heros',),
                        radius: 25,
                      ),
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(CupertinoIcons.camera_fill,
                            color: color.cupertinoMainColor, size: 19),
                      ),
                      ...
                      Container(
                        ...
                        child: Icon(CupertinoIcons.pen,
                            color: color.cupertinoMainColor, size: 20),
                      ),
                    ],
                  ),
                ],
                    ...
                    children: [
                      Stack(
                        ...
                        children: [
                           CircleAvatar(
                            radius: 29,
                            backgroundColor: color.cupertinoMainColor,
                          ),
                          const CircleAvatar(
                            radius: 27,
